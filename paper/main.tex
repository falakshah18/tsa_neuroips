...
\caption{Estimated energy consumption on Loihi 2 based on published hardware specs. [RESULTS PENDING: hardware validation].}
\label{fig:hardware}
\end{figure}
